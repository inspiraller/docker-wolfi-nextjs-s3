...
echo "Description: runs docker container of custom nextjs-server, with pm2, using shared bind mount on ../vlm-dir, copying nextjs-build into vlm-dir/build-sync and alternate blue green to build1 and build2"
